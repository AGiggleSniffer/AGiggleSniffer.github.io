...
Command: npx gltfjsx@6.5.2 spaceCamp.glb --types --shadows 
...
const SpaceCamp = (props: JSX.IntrinsicElements["group"]) => {
						...
						>
							...
							>
								<mesh
									...
									morphTargetDictionary={
										nodes.mesh_3.morphTargetDictionary
									}
									morphTargetInfluences={
										nodes.mesh_3.morphTargetInfluences
									}
								/>
							</group>
							<group
							...
							>
								<mesh
									...
									morphTargetDictionary={
										nodes.mesh_19.morphTargetDictionary
									}
									morphTargetInfluences={
										nodes.mesh_19.morphTargetInfluences
									}
								/>
							</group>
							<group
...
useGLTF.preload("/spaceCamp.glb");

export default SpaceCamp;
